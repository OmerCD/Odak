...
using ListviewProje.Properties;
...
using UcAyarlar = ListviewProje.Views.UserControllers.AnasayfaPages.UcAyarlar;
using UcTestler = ListviewProje.Views.UserControllers.AnasayfaPages.UcTestler;
...
namespace ListviewProje.Views.UserControllers
{
    public partial class Anasayfa : UserControl
    {
        ...
        public Anasayfa()
        {
            _main = this;
            InitializeComponent();
            AnasayfaIcerik.Content = new Baslangic();
        ...
        {
            //permanent.ChangeStack(menuStack, (Button)sender);
            AnasayfaIcerik.Content = new UcTestler();
        }

        private void Ayarlar(object sender, RoutedEventArgs e)
        {
            AnasayfaIcerik.Content = new UcAyarlar();
        }
